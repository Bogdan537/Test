...
class MyAdapter (listArray:ArrayList<ListItem>, context: Context): Adapter<MyAdapter.ViewHolder>() {
        ...
        fun bind(listItem: ListItem, context: Context)
        {
           ...
           im.setImageResource(listItem.image_id)
            itemView.setOnClickListener(){
               Toast.makeText(context, "Ви обрали : ${tvTitle.text}", Toast.LENGTH_SHORT).show()
